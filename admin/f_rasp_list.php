<?
# Вывод строк расписания занятий и экзаменов
function GetRasp() {
	global $plg;
...
/*	$body .= "<td class='header_title' valign='top'>Группа</td>";
	...
	$body .= "<td></td>";
	$body .= "<td class='header_title' valign='top'>Примечание</td><td></td><td></td>";*/

	#
	# Версия 1.02
	# Изменения в таблице расписания - название заголовков полей таблицы
	#		
...
/*	$body .= "<td class='header_title' valign='top'>Номер группы</td>";
	...
	$body .= "<td></td>";
	$body .= "<td class='header_title' valign='top'>Наличие свободных мест</td><td></td><td></td>";*/
	...
	$body .= "<a href='#'><img src='../images/edit.gif' onClick='javascript:price_edit()' border='0' alt='Редактировать'></a>";	
	$body .= "</td></tr>";	
	...
	#
	# Версия 1.04
	# Изменения в таблице расписания - количество колонок два
	#		
	$body .= "<td class='header_title' width='200' valign='top'>Дата начала занятий новой группы</td>";
	$body .= "<td></td>";
...
#	$body .= "<td></td>";
	$body .= "<td class='header_title' valign='top' align='right' width='*'>Наличие свободных мест</td><td></td><td></td>";		
	$body .= "</tr>";
	$body .= "<tr><td align='right' width='100%' colspan='11'>";
	$body .= "<a href='#'><img src='../images/new.gif' onClick='javascript:rasp_edit(0)' border='0' alt='Создать'></a>";	
	$body .= "</td></tr>";	
	$body .= "<tr><td colspan='11'></td></tr>";
...
#			$body .= "<td></td>";
			...
			$body .= "<a href='#'><img src='../images/edit.gif' onClick='rasp_edit($row->id)' border='0' class='btn' title='Изменить строку расписания'></a>&nbsp;";
